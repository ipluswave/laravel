...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<head>
		...
		<!-- Web Fonts  -->
		<?php echo HTML::style('http://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700,800%7CShadows+Into+Light'); ?>

		<?php echo HTML::style('https://fonts.googleapis.com/css?family=Roboto:400,400italic,500,300italic,300,100italic,100,700,700italic,500italic'); ?>
		...
		<?php echo HTML::style('vendor/simple-line-icons/css/simple-line-icons.min.css'); ?>

		<?php echo HTML::style('vendor/owl.carousel/assets/owl.carousel.min.css'); ?>

		<?php echo HTML::style('vendor/owl.carousel/assets/owl.theme.default.min.css'); ?>

		<?php echo HTML::style('vendor/magnific-popup/magnific-popup.min.css'); ?>
