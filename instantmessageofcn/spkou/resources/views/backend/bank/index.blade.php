...
@section('breadcrumb')
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="{{ route('backend.bank') }}">银行管理</a>
        </li>
    </ul>
@endsection
    ...
    <div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption font-green-sharp">
                <span class="caption-subject bold uppercase"> 银行列表</span>
            </div>
            <div class="actions">
                <a href="{{ route('backend.bank.create') }}" class="btn btn-circle red-sunglo btn-sm" data-target="#remote-modal" data-toggle="modal"><i class="fa fa-plus"></i> 新增银行</a>
            </div>
        </div>
