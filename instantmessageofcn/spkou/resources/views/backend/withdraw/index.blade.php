            ...
            <div class="table-container">
                <table class="table table-striped table-bordered table-hover table-checkable" id="withdraw-dt">
                    ...
                    <tr role="row" class="heading">
                        ...
                        <th><?= Lang::get('member.bank_card_no'); ?></th>
                        <th><?= Lang::get('member.bank_name'); ?></th>
                        <th><?= Lang::get('member.bank_address'); ?></th>
                        <th><?= Lang::get('member.amount'); ?></th>
                        <th>注册时间</th>
                        <th>操作</th>
                    </tr>
