    ...
    <div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption font-green-sharp">
                <span class="caption-helper">填上表格以修改权限组</span>
            </div>
            <div class="actions">
                ...
                <div class="form-body">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::text('group_name', $model->group_name, ['class' => 'form-control']) !!}
                        </div>
                    </div>
                    <div class="form-group">
                        <label>权限</label>
                        {!! Form::select('permissions[]', \App\Models\PermissionGroupPermission::getPermissionsLists(), $permissions, ['id' => 'permissions-selector', 'multiple']) !!}
                    </div>
                </div>
                <div class="form-actions">
                    <button type="submit" class="btn blue">编辑</button>
                </div>
            {!! Form::close() !!}
        </div>
    </div>
