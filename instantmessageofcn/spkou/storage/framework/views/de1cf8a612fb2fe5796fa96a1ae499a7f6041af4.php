                                ...
                                <div class="row">
                                    <div class="col-md-offset-7 col-md-5">
                                        <div class="pdd-vertical-90 text-white">
                                            ...
                                            <a href="<?php echo e(route('frontend.createorderv2')); ?>" class="btn btn-md btn-style-3 mrg-top-30">我要发单</a>
                                        </div>
                                        <!-- /padding -->
                                    </div>
                                    <!-- /column -->
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="pdd-vertical-90">
                                            ...
                                            <a href="<?php echo e(route('frontend.tailororders')); ?>" class="btn btn-md btn-style-4 mrg-top-30">我要接单</a>
                                        </div>
                                        <!-- /padding -->
                                    </div>
                                    <!-- /column -->
